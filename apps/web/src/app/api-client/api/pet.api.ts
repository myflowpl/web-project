...
export class PetApi {
   ...
   */
  public addPet(
    requestParameters?: AddPetRequestParams,
    observe?: 'body',
  ...
  public addPet(
    ...
    const consumes: string[] = ['application/json', 'application/xml'];
   ...
   */
  public deletePet(
    requestParameters?: DeletePetRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: undefined;
  ...
  public deletePet(
    ...
    let localVarPath = `/pet/${this.configuration.encodeParam({
      name: 'petId',
      value: petId,
      in: 'path',
      style: 'simple',
  ...
  public findPetsByStatus(
    requestParameters?: FindPetsByStatusRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  public findPetsByStatus(
    ...
    return this.httpClient.request<Array<Pet>>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  public findPetsByTags(
    requestParameters?: FindPetsByTagsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: 'application/json' | 'application/xml';
   ...
   */
  public getPetById(
    requestParameters?: GetPetByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: 'application/json' | 'application/xml';
  ...
  public getPetById(
    ...
    return this.httpClient.request<Pet>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   */
  public updatePet(
    requestParameters?: UpdatePetRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: undefined;
  ...
  public updatePetWithForm(
    requestParameters?: UpdatePetWithFormRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: undefined;
  ...
  public updatePetWithForm(
    ...
    if (name !== undefined) {
      localVarFormParams =
        (localVarFormParams.append('name', <any>name) as any) ||
        localVarFormParams;
    }
    if (status !== undefined) {
      localVarFormParams =
        (localVarFormParams.append('status', <any>status) as any) ||
        localVarFormParams;
    }
   ...
   */
  public uploadFile(
    requestParameters?: UploadFileRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
