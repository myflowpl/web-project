...
export class StoreApi {
   ...
   */
  public deleteOrder(
    requestParameters?: DeleteOrderRequestParams,
    observe?: 'body',
  ...
  public deleteOrder(
    ...
    let localVarPath = `/store/order/${this.configuration.encodeParam({
      name: 'orderId',
      value: orderId,
      in: 'path',
      style: 'simple',
   ...
   */
  public getOrderById(
    requestParameters?: GetOrderByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
   ...
   */
  public placeOrder(
    requestParameters?: PlaceOrderRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: 'application/json' | 'application/xml';
